...
/datum/surgery_operation/limb/bioware/cortex_imprint/mechanic
	...
	desc = "Update a robotic patient's operating system to a newer version, improving overall performance and resilience. Shame about all the adware." // OCULIS EDIT, ORIGINAL: desc = "Update a robotic patient's operating system to a \"newer version\", improving overall performance and resilience. Shame about all the adware."
	required_bodytype = BODYTYPE_ROBOTIC
	operation_flags = parent_type::operation_flags | OPERATION_MECHANIC

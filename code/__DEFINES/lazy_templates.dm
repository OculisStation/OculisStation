...
#define LAZY_TEMPLATE_KEY_SYNDICATE_STATION "LT_SYNDICATESTATION" // OCULIS EDIT ADDITION
...
#define LAZY_TEMPLATE_KEY_LIST_ALL(...) list( \
	...
	"Syndicate Space Station" = LAZY_TEMPLATE_KEY_SYNDICATE_STATION, /* OCULIS EDIT ADDITION */ \
)

...
/obj/structure/closet/secure_closet/des_two/sa_locker/PopulateContents()
	...
	new /obj/item/radio/headset/octavia/command(src) // OCULIS EDIT, ORIGINAL: new /obj/item/radio/headset/interdyne/command(src)
...
/obj/structure/closet/secure_closet/des_two/maa_locker/PopulateContents()
	...
	new /obj/item/radio/headset/octavia/command(src) // OCULIS EDIT, ORIGINAL: new /obj/item/radio/headset/interdyne(src)
